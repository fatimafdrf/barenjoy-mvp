      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          ...
          <div class="p-6 space-y-4">
            ...
            <!-- Product metadata -->
            <div class="space-y-1">
              <h3 class="font-bold text-app-text text-base group-hover:text-app-primary transition-colors">{{ item.name }}</h3>
          ...
          <div class="p-6 pt-0 border-t border-app-border mt-4 flex items-center justify-between gap-3">
            ...
            <div class="flex items-center gap-2">
              <span class="text-xs text-app-text-muted font-semibold">Stock:</span>
              <button
                @click="toggleStock(item.id, item.available)"
                :class="[
                  'px-2 py-1 text-[10px] font-bold rounded-lg uppercase tracking-wider transition-colors cursor-pointer border',
