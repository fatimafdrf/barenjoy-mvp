                ...
                <div class="space-y-2.5 my-2">
                  ...
                  >
                    <div class="flex justify-between items-center text-sm font-black text-slate-800">
                      ...
                      <span class="text-[9px] font-black uppercase text-slate-455 font-mono tracking-wider bg-white border border-slate-100 px-1.5 py-0.5 rounded">
